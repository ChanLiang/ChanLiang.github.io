...
My research focuses on developing effective and efficient post-training methods for large language models (LLMs), with an emphasis on improving their alignment and reasoning across diverse settings. This work spans the following directions:  
